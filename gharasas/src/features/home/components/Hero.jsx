...
const Hero = () => {
    ...
    return (
        <section id="inicio" className="relative h-auto md:h-screen md:min-h-[850px] flex items-center overflow-hidden bg-slate-900 pb-12 pt-28 md:py-0">
            ...
            <div className="container mx-auto px-6 md:px-6 relative z-20 h-full flex flex-col justify-center md:pt-15">
                <div className="max-w-xl">
                    ...
                    <motion.div
                        ...
                        className="backdrop-blur-xl bg-white/10 border border-white/20 p-4 md:p-5 rounded-3xl shadow-2xl relative overflow-hidden group max-w-sm"
                    >
                        ...
                        <h3 className="font-display font-bold text-lg mb-4 text-white flex items-center gap-2">
                            <span className="bg-white/20 p-1.5 rounded-lg material-symbols-outlined text-[12px]">calendar_month</span>
                            Contactar con Ghara
                        </h3>
                        <div className="space-y-3 relative z-10">
                            ...
                            <a
                                ...
                                className="w-full bg-green-500 hover:bg-green-600 text-white font-bold rounded-lg py-2.5 px-4 text-sm bg-opacity-95 shadow-lg shadow-green-500/30 hover:shadow-green-500/50 transition-all transform hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2 group/btn"
                            >
