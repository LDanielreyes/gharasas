...
const LocationMap = () => {
    ...
    const handleGetDirections = () => {
        if (!navigator.geolocation) {
            Swal.fire({ icon: 'info', title: 'Aviso', text: 'Tu navegador no soporta geolocalización.', confirmButtonColor: '#22c5e8' });
            return;
        }
        ...
        navigator.geolocation.getCurrentPosition(
            ...
            () => {
                Swal.fire({ icon: 'info', title: 'Aviso', text: 'No pudimos obtener tu ubicación. Por favor permite el acceso a la ubicación.', confirmButtonColor: '#22c5e8' });
            }
        );
    };
