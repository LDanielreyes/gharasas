        ...
        <footer className="bg-slate-900 dark:bg-black text-white pt-24 overflow-hidden relative transition-colors duration-500">
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                >
                    ...
                    >
                        <h4 className="font-bold text-cyan-400 dark:text-cyber-cyan dark:shadow-[0_0_10px_rgba(0,240,255,0.4)] mb-6 text-xs uppercase tracking-widest transition-all">Legal</h4>
                        <ul className="space-y-3 text-sm text-gray-400 dark:text-slate-500">
                            {navigationLinks.legal.map((item, index) => (
                                <motion.li
                                    key={item.name}
                                    initial={{ opacity: 0, x: -10 }}
                                    whileInView={{ opacity: 1, x: 0 }}
                ...
                >
                    ...
                    <div className="flex items-center gap-4 text-gray-600">
                        <a
                            ...
                            onClick={(e) => { e.preventDefault(); navigate('/politica-de-datos'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
